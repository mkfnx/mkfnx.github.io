...
1. [Algoritmo básico para calcular los discos necesarios para cierto peso (Supondremos que tenemos discos ilimitados de cada peso)](/fCC-Barbell-1/)
2. [Creación de elementos HTML y CSS para visualizar resultado](/fCC-Barbell-2/)
3. Enlazar nuestro JavaScript con los elementos HTML y CSS para crear una visualización dinámica. [Creación de elementos HTML y CSS para visualizar resultado](/fCC-Barbell-3/)
...
![Ejemplo de resultado de proyecto](/images/barbell-calculator-example-just-lift-app.png)
-
