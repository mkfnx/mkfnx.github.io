---
layout: post
title: Ejemplo desarrollo frontend&#58; Calculadora de peso de barra olimpica - Fase 1, algortimo básico.
---

En esta primera fase de nuestro proyecto de calculadora de peso para barra olímpica programaremos un algoritmo en JavaScript que resuelva un caso básico de este problema. Recordemos que este proyecto puede servir como guía para proyectos de la certificación frontend de freeCodeCamp. Solución en CodePen: <https://codepen.io/mkfnx/pen/OJVgbMv/>

# Descripción Del Problema
Crea una función `getPlatesForWeight(weight)` la cual recibe el parámetro `weight` el cual es un número que indica el peso en libras que deseamos para nuestra barra olímpica. Este peso debe ser mayor de 45 lbs y debe ser un múltiplo de 5, ya que solo se pueden lograr estos pesos con los discos de un conjunto típico, que contiene discos de 2.5, 5, 10, 25, 35 y 45 lbs.

La función mencionada debe devolver un `Object` (o `Map`) cuyas llaves serán los pesos de los discos típicos y cuyos valores serán la cantidad de discos de cada peso que se deben cargar en cada lado de la barra, ya que el peso debe estar balanceado. Y otro punto a tomar en cuenta es que la barra pesa por si misma 45 lbs.
...
Recuerda que en este enlace <https://codepen.io/mkfnx/pen/OJVgbMv/> puedes en cualquier momento puedes observar el resultado final de esta fase del proyecto para obtener más contexto.

## Configuración inicial
* Definir valores constantes que usaremos en el proyecto para obtener un código más limpio, evitando los llamados "números mágicos"
...
* Crear nuestra función y verificar que se llama correctamente, colocandole un `console.log` que muestre el peso que se pasa a la función.
...
console.log(getNeededPlatesForWeight(200));
```

* Inicializar el Map de discos. Usar notación de llave (roder de [] los valores de key de nuestro Object)
...
* Verificar que el peso restante (ya contando el peso de la barra) sea un múltiplo de 2.5, es decir que pueda llegarse a ese peso usando los discos típicos, de no ser así, devolvemos el Map de discos necesarios tal y como lo inicializamos con los valores en 0s.
...
Probemos llamar a nuestra función con distintos valores que nos ayuden a verificar que se comporta de manera correcta en varios escenarios, por ejemplo, pasando valores menores al peso de 45 lbs de la barra y pasando distintos valores válidos y verificando que la suma del peso de los discos de ambos lados y la barra sea la correcta.
...
Analizamos este problema en distintas secciones con propósito específico como inicialización, validación y problema principal.
